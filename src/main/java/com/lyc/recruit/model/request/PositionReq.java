...
public class PositionReq {
    ...
    private  ResourceManReq resourceManReq;

    public ResourceManReq getResourceManReq() {
        return resourceManReq;
    }

    public void setResourceManReq(ResourceManReq resourceManReq) {
        this.resourceManReq = resourceManReq;
    }
